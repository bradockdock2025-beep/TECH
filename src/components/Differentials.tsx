const differentials = [
  {
    ...
    title: "Prazo ou não cobramos.",
    proof: "100% dos projetos entregues na janela acordada.",
    description:
      "Cada projeto tem uma data de entrega contratual. Se não cumprirmos, trabalhamos sem custo adicional até entregar. Está no contrato.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: "Equipa, não freelancer.",
    proof: "Designer + programador + gestor desde o dia 1.",
    description:
      "Cada projeto tem três pessoas dedicadas. Sem dependência de uma única pessoa que pode ficar indisponível a meio do projeto.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: "Código que permanece seu.",
    proof: "Repositório completo. Sem lock-in de plataforma.",
    description:
      "No fim do projeto, o código é integralmente seu. Repositório documentado, infraestrutura transferível. Muda de equipa sem perder nada.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-5xl lg:text-6xl font-black text-white tracking-[-0.02em] leading-tight">
            Menos discurso.
            <br />
            <span className="text-white/40">Mais razões concretas.</span>
          </h2>
        </div>
